...
class TestCase:
    ...
    def __init__(self,dt):
        ...
        self._order = []
        self._constants_inputs = []
        self._variables_inputs = []

    def setInputOrder(self,order_list):
        self._order = order_list
    
    def getConstantsInputs(self):
        return self._constants_inputs
    
    def getVariablesInputs(self):
        return self._variables_inputs
