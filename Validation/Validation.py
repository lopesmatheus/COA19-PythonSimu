...
import pandas as pd
valid_python = pd.read_csv('Validation/Validation_python.csv')
valid_matlab = pd.read_csv('Validation/Validation_MATLAB.csv',names=['time','TBAS_SENSOR','FAV_POSITION_DEG'])
...
plt.savefig('Validation/Validation_TBAS.png')
...
plt.savefig('Validation/Validation_FAVPOS.png')
